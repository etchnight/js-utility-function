...
function getStyle(ele: Element) {
  ...
  function filterObj(
    currObj: CSSStyleDeclaration,
    initObj: CSSStyleDeclaration
 ...
 */
function toInlineStyle(selector: string) {
...
toInlineStyle(
  `#layouts > div.fn__flex.fn__flex-1 > div.layout__center.fn__flex.fn__flex-1 > div > div > div.layout-tab-container.fn__flex-1 > div:nth-child(5) > div.protyle-content.protyle-content--transition > div.protyle-wysiwyg.protyle-wysiwyg--attr > div:nth-child(2)`
);
