      ...
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 24:
              _context.next = 26;
              return Promise.all(list.map(cb));
            case 26:
 ...
 * @returns
 */
function interruptByOut(fn, throwVar) {
      ...
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          intervalID = setInterval(function () {
            var func = new Function("if (".concat(throwVar, ") {\n          console.log(\"\u9000\u51FA\");\n          throw \"interrupt\";\n        } else {\n          console.log(\"\u4E0D\u9000\u51FA\");\n        }\n      "));
            func();
          }, delay);
          _context2.next = 4;
          return fn();
 ...
 * @returns
 */
var promiseExample = function promiseExample(timeout, text) {
